...
class ExtendController extends Controller
{
    ...
    {
        $products = Cache::remember('child_products', 60, function () {
            try {
                $response = Http::withoutVerifying()->withOptions(['verify' => false])->get(config('app.products_api'), ['unique_slug' => 'teachify-lms']);
