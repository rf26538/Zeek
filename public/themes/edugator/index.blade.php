        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 col-lg-6 hero-right-col">
                    <div class="hero-right-wrap">
                    @if(!empty($bImage))
                    <img src="{{ asset('uploads/banner/' . $bImage) }}" class="img-fluid" />
                    @else
                    <img src="{{theme_url('images/hero-image.png')}}" class="img-fluid" />
                    @endif
                    </div>
...
<div class="row">
    <div class="col-md-6">
    <h3 class="mb-2 text-xl font-semibold text-instrucko-text">1. Initial Screening</h3><p class="text-sm text-instrucko-gray">Our teacher recruitment team will run through your CV and application.</p>
    </div>
    <div class="col-md-6">
    <h3 class="mb-2 text-xl font-semibold text-instrucko-text">2. Short Demo</h3><p class="text-sm text-instrucko-gray">We’ll schedule a short teaching demo to understand your style of teaching.</p>
    </div>
    <div class="col-md-6">
    <h3 class="mb-2 text-xl font-semibold text-instrucko-text">3. Background Checks</h3><p class="text-sm text-instrucko-gray">Safety for our learners is a key priority, so we’ll perform background checks.</p>
    </div>
    <div class="col-md-6">
    <h3 class="mb-2 text-xl font-semibold text-instrucko-text">4. Welcome Onboard</h3><p class="text-sm text-instrucko-gray">We’ll set you up with instrucko’s LMS, and prepare you to book your first class.</p>
    </div>
</div>
