...
<head>
    ...
    <!-- ZeekHub Enterprises Version -->
    <meta name="generator" content="ZeekHub Enterprises LMS v.{{config('app.version')}}" />
            ...
            <div id="page-wrapper">
                ...
                <div class="admin-footer">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <p class="m-0"><a href="#" target="_blank">ZeekHub Enterprises LMS</a> Version {{config('app.version')}}</p>
                            </div>
                        </div>
                    </div>
                </div>
