...
class OptionSeeder extends Seeder
{
    ...
    public function run()
    {
        $options = [
            ...
            'date_format' => 'd/m/Y',
            'time_format' => 'H:i',
            'site_name' => 'ZeekHub Enterprises LMS',
            'site_title' => 'ZeekHub Enterprises',
            'email_address' => 'contact@zeekhub.com',
            ...
            'about_us_page' => '3',
            'cookie_alert' => 'json_encode_value_{"enable":"1","message":"By using ZeekHub EnterprisesLMS you accept our cookies and agree to our privacy policy, including cookie policy. {privacy_policy_url}"}',
